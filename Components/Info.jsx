...
export default function Info() {
    return (
        <div className="outer-body">
            <img className="profile--img" src="https://imgv3.fotor.com/images/gallery/Realistic-Male-Profile-Picture.jpg" alt="profile-pic" />
            <h1>M. Uzair Shahid</h1>
            <h2>MERN Developer</h2>
            <p>RJDEV.netlify.app</p>
            <div className="btn--grp">
                <button className="btn--email"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                ...
                <button className="btn--linkdin"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
